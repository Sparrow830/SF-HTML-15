...
function initSlider() {
  ...
  function initSwitch() {
    ...
    projectImageArea.innerHTML += '<button class="arrow-button arrow-button_left"></button>';
    projectImageArea.innerHTML += '<button class="arrow-button arrow-button_right"></button>';

    projectsContent.querySelectorAll('.arrow-button').forEach(arrowButton => {
